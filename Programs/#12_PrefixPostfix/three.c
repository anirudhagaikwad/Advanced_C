/*
Radha have to create stack of numbers and she wants to reverse that stack.
Help Radha for same. Use recursion to solve problem.
...
// Below is the function thatreverses the given stack
